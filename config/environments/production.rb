...
Rails.application.configure do
  ...
  config.force_ssl = true # Forces the use of HTTPS
  config.session_store :cookie_store, key: '_denuevo_session', secure: true
  ...
  config.active_job.queue_name_prefix = "denuevo_production"
